...
Diminui o valor de determinada key para o valor recebido Complexidade Temporal\+: O($\vert$\+V$\vert$), where V = stops 
\begin{DoxyParams}{Parameters}
{\em key} & key a ser alterada \\
\hline
{\em value} & valor para o qual queremos alterar \\
\hline
\end{DoxyParams}
...
Verifica se uma determinada key está presente na heap Complexidade Temporal\+: O($\vert$\+V$\vert$), where V = stops 
\begin{DoxyParams}{Parameters}
{\em key} & key que queremos verificar se está na heap \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
true se a key estiver presente na heap, false se não 
\end{DoxyReturn}
...
Insere o par (key, value) na heap Complexidade Temporal\+: O($\vert$\+V$\vert$), where V = stops 
\begin{DoxyParams}{Parameters}
{\em key} & key do par a ser inserido \\
\hline
{\em value} & valor do par a ser inserido \\
\hline
\end{DoxyParams}
...
Remove e retorna a key de menor valor Complexidade Temporal\+: O(log$\vert$\+V$\vert$), where V = stops \begin{DoxyReturn}{Returns}
key de menor valor 
\end{DoxyReturn}
